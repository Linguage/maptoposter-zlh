...
Generated posters are saved to `generated_posters/` by default. The script creates the directory automatically, and it is ignored by git so local outputs do not pollute the repository.
